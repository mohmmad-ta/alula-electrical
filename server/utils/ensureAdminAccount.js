...
const ensureBootstrapAdmin = async ({ userID, password }, source) => {
    if (!userID || !password) {
        console.warn(`Admin bootstrap skipped from ${source}: userID or password is missing.`);
        return;
    }
...
module.exports = async () => {
    ...
    const hasPrimaryAdminConfig = primaryAdmin.userID || primaryAdmin.password;
    const adminAccounts = [
